...
#define PLL_IN_DIV		3
    ...
    uint32_t SystemCoreClock  = 120000000;   				//System Clock Frequency (Core Clock)
    uint32_t CyclesPerUs      = (120000000 / 1000000); 		//Cycles per micro second
    ...
    uint32_t CyclesPerUs      = (150000000 / 1000000); 		//Cycles per micro second
#endif
