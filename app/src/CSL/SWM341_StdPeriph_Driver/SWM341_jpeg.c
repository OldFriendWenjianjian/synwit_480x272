/*******************************************************************************************************************************
* @brief	JPEG driver, used to decode jpeg image
*
*
********************************************************************************************************************************
* @attention
...
/*******************************************************************************************************************************
* @brief	JPEG init
* @param	JPEGx is the JPEG to init
* @param	initStruct is data used to init the JPEG
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	JPEG decode specified jpeg image
* @param	JPEGx is the JPEG to use
* @param	jfif_info specify the image to decode
* @param	jpeg_outset specify the he decoded data, e.g. RGB pixel data
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	JPEG busy query
* @param	JPEGx is the JPEG to query
* @return	1 JPEG is busy for decoding, 0 decode done, JPEG is in idle
*******************************************************************************************************************************/
