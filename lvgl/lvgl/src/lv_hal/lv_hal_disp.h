...
uint8_t del_prev  :
    ...
    uint8_t inv_area_nosync[LV_INV_BUF_SIZE];
    uint32_t inv_p : 10;
 ...
 */
LV_EXPORT_API void lv_disp_drv_init(lv_disp_drv_t * driver);
 ...
 */
LV_EXPORT_API void lv_disp_buf_init(lv_disp_buf_t * disp_buf, void * buf1, void * buf2, uint32_t size_in_px_cnt);
 ...
 */
LV_EXPORT_API lv_disp_t * lv_disp_drv_register(lv_disp_drv_t * driver);
 ...
 */
LV_EXPORT_API void lv_disp_drv_update(lv_disp_t * disp, lv_disp_drv_t * new_drv);

/**
 * Remove a display
 * @param disp pointer to display
 */
LV_EXPORT_API void lv_disp_remove(lv_disp_t * disp);

/**
 * Set a default screen. The new screens will be created on it by default.
 * @param disp pointer to a display
 */
LV_EXPORT_API void lv_disp_set_default(lv_disp_t * disp);

/**
 * Get the default display
 * @return pointer to the default display
 */
LV_EXPORT_API lv_disp_t * lv_disp_get_default(void);
 ...
 */
LV_EXPORT_API lv_coord_t lv_disp_get_hor_res(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API lv_coord_t lv_disp_get_ver_res(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API bool lv_disp_get_antialiasing(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API lv_coord_t lv_disp_get_dpi(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API lv_disp_size_t lv_disp_get_size_category(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API void lv_disp_set_rotation(lv_disp_t * disp, lv_disp_rot_t rotation);
 ...
 */
LV_EXPORT_API lv_disp_rot_t lv_disp_get_rotation(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_FLUSH_READY void lv_disp_flush_ready(lv_disp_drv_t * disp_drv);
 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_FLUSH_READY bool lv_disp_flush_is_last(lv_disp_drv_t * disp_drv);
 ...
 */
LV_EXPORT_API lv_disp_t * lv_disp_get_next(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API lv_disp_buf_t * lv_disp_get_buf(lv_disp_t * disp);

/**
 * Get the number of areas in the buffer
 * @return number of invalid areas
 */
LV_EXPORT_API uint16_t lv_disp_get_inv_buf_size(lv_disp_t * disp);

/**
 * Pop (delete) the last 'num' invalidated areas from the buffer
 * @param num number of areas to delete
 */
LV_EXPORT_API void _lv_disp_pop_from_inv_buf(lv_disp_t * disp, uint16_t num);
 ...
 */
LV_EXPORT_API bool lv_disp_is_double_buf(lv_disp_t * disp);
 ...
 * @return true: double buffered; false: not double buffered
 */
LV_EXPORT_API bool lv_disp_is_true_double_buf(lv_disp_t * disp);
LV_EXPORT_API void lv_refr_vdb_flush(void);
