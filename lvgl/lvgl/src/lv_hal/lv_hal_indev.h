...
enum {
    LV_GESTURE_DIR_TOP = 0x1,     /**< Gesture dir up. */
    LV_GESTURE_DIR_BOTTOM = 0x2,  /**< Gesture dir down. */
    LV_GESTURE_DIR_LEFT = 0x4,    /**< Gesture dir left. */
    LV_GESTURE_DIR_RIGHT = 0x8,   /**< Gesture dir right. */
};
 ...
 */
LV_EXPORT_API void lv_indev_drv_init(lv_indev_drv_t * driver);
 ...
 */
LV_EXPORT_API lv_indev_t * lv_indev_drv_register(lv_indev_drv_t * driver);
 ...
 */
LV_EXPORT_API void lv_indev_drv_update(lv_indev_t * indev, lv_indev_drv_t * new_drv);
 ...
 * is NULL
 */
LV_EXPORT_API lv_indev_t * lv_indev_get_next(lv_indev_t * indev);
 ...
 */
LV_EXPORT_API bool _lv_indev_read(lv_indev_t * indev, lv_indev_data_t * data);
