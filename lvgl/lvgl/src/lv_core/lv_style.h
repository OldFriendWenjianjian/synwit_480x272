 ...
 */
LV_EXPORT_API void lv_style_init(lv_style_t * style);
 ...
 */
LV_EXPORT_API void lv_style_copy(lv_style_t * style_dest, const lv_style_t * style_src);

/**
 * Initialize a style list
 * @param list a style list to initialize
 */
LV_EXPORT_API void lv_style_list_init(lv_style_list_t * list);
 ...
 */
LV_EXPORT_API void lv_style_list_copy(lv_style_list_t * list_dest, const lv_style_list_t * list_src);
 ...
 */
LV_EXPORT_API void _lv_style_list_add_style(lv_style_list_t * list, lv_style_t * style);
 ...
 */
LV_EXPORT_API void _lv_style_list_remove_style(lv_style_list_t * list, lv_style_t * style);
 ...
 * @param list pointer to a style list.
 */
LV_EXPORT_API void _lv_style_list_reset(lv_style_list_t * style_list);
 ...
 */
LV_EXPORT_API void lv_style_reset(lv_style_t * style);
 ...
 */
LV_EXPORT_API uint16_t _lv_style_get_mem_size(const lv_style_t * style);
 ...
 */
LV_EXPORT_API void lv_style_copy(lv_style_t * dest, const lv_style_t * src);
 ...
 */
LV_EXPORT_API bool lv_style_remove_prop(lv_style_t * style, lv_style_property_t prop);
 ...
 */
LV_EXPORT_API void _lv_style_set_int(lv_style_t * style, lv_style_property_t prop, lv_style_int_t value);
 ...
 */
LV_EXPORT_API void _lv_style_set_color(lv_style_t * style, lv_style_property_t prop, lv_color_t color);
 ...
 */
LV_EXPORT_API void _lv_style_set_opa(lv_style_t * style, lv_style_property_t prop, lv_opa_t opa);
 ...
 */
LV_EXPORT_API void _lv_style_set_ptr(lv_style_t * style, lv_style_property_t prop, const void * p);
 ...
 * @note for performance reasons it's not checked if the property really has integer type
 */
LV_EXPORT_API int16_t _lv_style_get_int(const lv_style_t * style, lv_style_property_t prop, lv_style_int_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has color type
 */
LV_EXPORT_API int16_t _lv_style_get_color(const lv_style_t * style, lv_style_property_t prop, lv_color_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has opacity type
 */
LV_EXPORT_API int16_t _lv_style_get_opa(const lv_style_t * style, lv_style_property_t prop, lv_opa_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has pointer type
 */
LV_EXPORT_API int16_t _lv_style_get_ptr(const lv_style_t * style, lv_style_property_t prop, const void ** res);
 ...
 */
LV_EXPORT_API lv_style_t * lv_style_list_get_local_style(lv_style_list_t * list);
 ...
 */
LV_EXPORT_API lv_style_t * _lv_style_list_get_transition_style(lv_style_list_t * list);
 ...
 */
LV_EXPORT_API lv_style_t * _lv_style_list_add_trans_style(lv_style_list_t * list);
 ...
 * @note for performance reasons it's not checked if the property really has integer type
 */
LV_EXPORT_API void _lv_style_list_set_local_int(lv_style_list_t * list, lv_style_property_t prop, lv_style_int_t value);
 ...
 * @note for performance reasons it's not checked if the property really has color type
 */
LV_EXPORT_API void _lv_style_list_set_local_color(lv_style_list_t * list, lv_style_property_t prop, lv_color_t value);
 ...
 * @note for performance reasons it's not checked if the property really has opacity type
 */
LV_EXPORT_API void _lv_style_list_set_local_opa(lv_style_list_t * list, lv_style_property_t prop, lv_opa_t value);
 ...
 * @note for performance reasons it's not checked if the property really has pointer type
 */
LV_EXPORT_API void _lv_style_list_set_local_ptr(lv_style_list_t * list, lv_style_property_t prop, const void * value);
 ...
 * @note for performance reasons it's not checked if the property really has integer type
 */
LV_EXPORT_API lv_res_t _lv_style_list_get_int(lv_style_list_t * list, lv_style_property_t prop, lv_style_int_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has color type
 */
LV_EXPORT_API lv_res_t _lv_style_list_get_color(lv_style_list_t * list, lv_style_property_t prop, lv_color_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has opacity type
 */
LV_EXPORT_API lv_res_t _lv_style_list_get_opa(lv_style_list_t * list, lv_style_property_t prop, lv_opa_t * res);
 ...
 * @note for performance reasons it's not checked if the property really has pointer type
 */
LV_EXPORT_API lv_res_t _lv_style_list_get_ptr(lv_style_list_t * list, lv_style_property_t prop, const void ** res);
 ...
 * @return true: valid
 */
LV_EXPORT_API bool lv_debug_check_style(const lv_style_t * style);
 ...
 * @return true: valid
 */
LV_EXPORT_API bool lv_debug_check_style_list(const lv_style_list_t * list);
