 ...
 */
LV_EXPORT_API void _lv_refr_init(void);
 ...
 */
LV_EXPORT_API void lv_refr_now(lv_disp_t * disp);
 ...
 * only one display)
 */
LV_EXPORT_API void _lv_inv_area(lv_disp_t * disp, const lv_area_t * area_p);

/**
 * Get the display which is being refreshed
 * @return the display being refreshed
 */
LV_EXPORT_API lv_disp_t * _lv_refr_get_disp_refreshing(void);
 ...
 */
LV_EXPORT_API void _lv_refr_set_disp_refreshing(lv_disp_t * disp);
 ...
 */
LV_EXPORT_API uint32_t lv_refr_get_fps_avg(void);
#endif
 ...
 */
LV_EXPORT_API void _lv_disp_refr_task(lv_task_t * task);
