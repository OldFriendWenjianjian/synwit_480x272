...
#ifdef __cplusplus
#define _OBJ_GET_STYLE_NO_CAST(prop_name, func_name, value_type, style_type)                                \
    static inline value_type lv_obj_get_style_##func_name(const lv_obj_t * obj, uint8_t part)       \
    {                                                                                               \
...
#define _LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(prop_name, func_name, value_type, style_type)                                      \
    _OBJ_GET_STYLE_NO_CAST(prop_name, func_name, value_type, style_type)                                                         \
    _OBJ_SET_STYLE_LOCAL(prop_name, func_name, value_type, style_type)                                                   \
    _OBJ_SET_STYLE(prop_name, func_name, value_type, style_type)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(BG_COLOR, bg_color, lv_color_t, _color)
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(BG_GRAD_COLOR, bg_grad_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(BORDER_COLOR, border_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(OUTLINE_COLOR, outline_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(SHADOW_COLOR, shadow_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(PATTERN_RECOLOR, pattern_recolor, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(VALUE_COLOR, value_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(TEXT_COLOR, text_color, lv_color_t, _color)
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(TEXT_SEL_COLOR, text_sel_color, lv_color_t, _color)
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(TEXT_SEL_BG_COLOR, text_sel_bg_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(LINE_COLOR, line_color, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(IMAGE_RECOLOR, image_recolor, lv_color_t, _color)
...
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(SCALE_GRAD_COLOR, scale_grad_color, lv_color_t, _color)
_LV_OBJ_STYLE_SET_GET_NOCAST_DECLARE(SCALE_END_COLOR, scale_end_color, lv_color_t, _color)
