...
typedef void (*lv_event_cb_interceptor_t)(struct _lv_obj_t* obj, lv_event_t event, void *data, lv_event_cb_t xcb);
...
typedef struct _lv_obj_t {
    ...
    lv_event_cb_interceptor_t event_cb_interceptor;
    void* event_cb_interceptor_data;

    lv_event_cb_t event_cb; /**< Event callback function */
    lv_signal_cb_t signal_cb; /**< Object type specific signal function*/
    lv_design_cb_t design_cb; /**< Object type specific design function*/

    void * event_cb_data;   /**< Custom callback data for event callback. */
    void * custom_view_data;    /**< Custom object type specific extended data*/
    ...
    lv_gesture_dir_t gesture_parent_dir;
 ...
 * Init. the 'lv' library.
 */
LV_EXPORT_API void lv_init(void);
...
LV_EXPORT_API void lv_deinit(void);
#endif
 ...
 */
LV_EXPORT_API lv_obj_t * lv_obj_create(lv_obj_t * parent, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API lv_res_t lv_obj_del(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_del_anim_ready_cb(lv_anim_t * a);
#endif
 ...
 * @see lv_async_call
 */
LV_EXPORT_API void lv_obj_del_async(struct _lv_obj_t * obj);

/**
 * Delete all children of an object
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_clean(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_invalidate_area(const lv_obj_t * obj, const lv_area_t * area);

/**
 * Mark the object as invalid therefore its current position will be redrawn by 'lv_refr_task'
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_invalidate(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_area_is_visible(const lv_obj_t * obj, lv_area_t * area);
 ...
 * @return true: visible; false: not visible (hidden, out of parent, on other screen, etc)
 */
LV_EXPORT_API bool lv_obj_is_visible(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_set_parent(lv_obj_t * obj, lv_obj_t * parent);

/**
 * Move and object to the foreground
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_move_foreground(lv_obj_t * obj);

/**
 * Move and object to the background
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_move_background(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_set_pos(lv_obj_t * obj, lv_coord_t x, lv_coord_t y);
 ...
 */
LV_EXPORT_API void lv_obj_set_x(lv_obj_t * obj, lv_coord_t x);
 ...
 * @param y new distance from the top of the parent
 */
LV_EXPORT_API void lv_obj_set_y(lv_obj_t * obj, lv_coord_t y);
 ...
 * @param h new height
 */
LV_EXPORT_API void lv_obj_set_size(lv_obj_t * obj, lv_coord_t w, lv_coord_t h);
 ...
 * @param w new width
 */
LV_EXPORT_API void lv_obj_set_width(lv_obj_t * obj, lv_coord_t w);
 ...
 * @param h new height
 */
LV_EXPORT_API void lv_obj_set_height(lv_obj_t * obj, lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_obj_set_width_fit(lv_obj_t * obj, lv_coord_t w);
 ...
 */
LV_EXPORT_API void lv_obj_set_height_fit(lv_obj_t * obj, lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_obj_set_width_margin(lv_obj_t * obj, lv_coord_t w);
 ...
 */
LV_EXPORT_API void lv_obj_set_height_margin(lv_obj_t * obj, lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_obj_align(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t x_ofs, lv_coord_t y_ofs);
 ...
 * @param x_ofs x coordinate offset after alignment
 */
LV_EXPORT_API void lv_obj_align_x(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t x_ofs);
 ...
 * @param y_ofs y coordinate offset after alignment
 */
LV_EXPORT_API void lv_obj_align_y(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t y_ofs);
 ...
 * @param y_ofs y coordinate offset after alignment
 */
LV_EXPORT_API void lv_obj_align_mid(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t x_ofs, lv_coord_t y_ofs);
 ...
 * @param x_ofs x coordinate offset after alignment
 */
LV_EXPORT_API void lv_obj_align_mid_x(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t x_ofs);
 ...
 * @param y_ofs y coordinate offset after alignment
 */
LV_EXPORT_API void lv_obj_align_mid_y(lv_obj_t * obj, const lv_obj_t * base, lv_align_t align, lv_coord_t y_ofs);

/**
 * Realign the object based on the last `lv_obj_align` parameters.
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_realign(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_set_auto_realign(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_ext_click_area(lv_obj_t * obj, lv_coord_t left, lv_coord_t right, lv_coord_t top, lv_coord_t bottom);
 ...
 */
LV_EXPORT_API void lv_obj_add_style(lv_obj_t * obj, uint8_t part, lv_style_t * style);
 ...
 */
LV_EXPORT_API void lv_obj_remove_style(lv_obj_t * obj, uint8_t part, lv_style_t * style);
 ...
 * E.g. `LV_OBJ_PART_MAIN`, `LV_BTN_PART_MAIN`, `LV_SLIDER_PART_KNOB`
 */
LV_EXPORT_API void lv_obj_clean_style_list(lv_obj_t * obj, uint8_t part);
 ...
 * E.g. `LV_OBJ_PART_MAIN`, `LV_BTN_PART_MAIN`, `LV_SLIDER_PART_KNOB`
 */
LV_EXPORT_API void lv_obj_reset_style_list(lv_obj_t * obj, uint8_t part);
 ...
 */
LV_EXPORT_API void lv_obj_refresh_style(lv_obj_t * obj, uint8_t part, lv_style_property_t prop);
 ...
 */
LV_EXPORT_API void lv_obj_report_style_mod(lv_style_t * style);
 ...
 */
LV_EXPORT_API void _lv_obj_set_style_local_color(lv_obj_t * obj, uint8_t type, lv_style_property_t prop, lv_color_t color);
 ...
 */
LV_EXPORT_API void _lv_obj_set_style_local_int(lv_obj_t * obj, uint8_t type, lv_style_property_t prop, lv_style_int_t value);
 ...
 */
LV_EXPORT_API void _lv_obj_set_style_local_opa(lv_obj_t * obj, uint8_t type, lv_style_property_t prop, lv_opa_t opa);
 ...
 */
LV_EXPORT_API void _lv_obj_set_style_local_ptr(lv_obj_t * obj, uint8_t type, lv_style_property_t prop, const void * value);
 ...
 */
LV_EXPORT_API bool lv_obj_remove_style_local_prop(lv_obj_t * obj, uint8_t part, lv_style_property_t prop);
 ...
 */
LV_EXPORT_API void _lv_obj_disable_style_caching(lv_obj_t * obj, bool dis);
 ...
 */
LV_EXPORT_API void lv_obj_set_hidden(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_adv_hittest(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_click(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_top(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_drag(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_drag_dir(lv_obj_t * obj, lv_drag_dir_t drag_dir);
 ...
 */
LV_EXPORT_API void lv_obj_set_drag_throw(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_drag_parent(lv_obj_t * obj, bool en);
...
*/
LV_EXPORT_API void lv_obj_set_focus_parent(lv_obj_t * obj, bool en);
...
*/
LV_EXPORT_API void lv_obj_set_gesture_parent(lv_obj_t * obj, bool en);

/**
* Set the directions to use parent for gesture related operations.
* If trying to gesture the object with the direction, the parent will be moved instead.
* @param obj pointer to an object
* @param gesture_dir bitwise OR of allowed gesture directions
*/
LV_EXPORT_API void lv_obj_set_gesture_parent_dir(lv_obj_t* obj, lv_gesture_dir_t gesture_dir);
 ...
 */
LV_EXPORT_API void lv_obj_set_parent_event(lv_obj_t * obj, bool en);
 ...
 */
LV_EXPORT_API void lv_obj_set_base_dir(lv_obj_t * obj, lv_bidi_dir_t dir);
 ...
 */
LV_EXPORT_API void lv_obj_add_protect(lv_obj_t * obj, uint8_t prot);
 ...
 * @param prot 'OR'-ed values from `lv_protect_t`
 */
LV_EXPORT_API void lv_obj_clear_protect(lv_obj_t * obj, uint8_t prot);
 ...
 */
LV_EXPORT_API void lv_obj_set_state(lv_obj_t * obj, lv_state_t state);
 ...
 */
LV_EXPORT_API void lv_obj_add_state(lv_obj_t * obj, lv_state_t state);
 ...
 */
LV_EXPORT_API void lv_obj_clear_state(lv_obj_t * obj, lv_state_t state);
 ...
 */
LV_EXPORT_API void lv_obj_finish_transitions(lv_obj_t * obj, uint8_t part);
#endif
 ...
 */
LV_EXPORT_API void lv_obj_set_event_cb(lv_obj_t * obj, lv_event_cb_t event_cb);

LV_EXPORT_API void lv_obj_set_event_cb_with_data(lv_obj_t* obj, lv_event_cb_t event_cb, void *cb_user_data);
LV_EXPORT_API void* lv_obj_get_event_cb_data(lv_obj_t* obj);
 ...
 */
LV_EXPORT_API lv_res_t lv_event_send(lv_obj_t * obj, lv_event_t event, const void * data);
 ...
 */
LV_EXPORT_API lv_res_t lv_event_send_refresh(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_event_send_refresh_recursive(lv_obj_t * obj);
 ...
 * @return LV_RES_OK: `obj` was not deleted in the event; LV_RES_INV: `obj` was deleted in the event
 */
LV_EXPORT_API lv_res_t lv_event_send_func(lv_event_cb_t event_xcb, lv_obj_t * obj, lv_event_t event, const void * data);

/**
 * Get the `data` parameter of the current event
 * @return the `data` parameter
 */
LV_EXPORT_API const void * lv_event_get_data(void);
 ...
 */
LV_EXPORT_API void lv_obj_set_signal_cb(lv_obj_t * obj, lv_signal_cb_t signal_cb);
 ...
 */
LV_EXPORT_API lv_res_t lv_signal_send(lv_obj_t * obj, lv_signal_t signal, void * param);
 ...
 */
LV_EXPORT_API void lv_obj_set_design_cb(lv_obj_t * obj, lv_design_cb_t design_cb);
 ...
 */
LV_EXPORT_API void * lv_obj_allocate_ext_attr(lv_obj_t * obj, uint16_t ext_size);
 ...
 * @param obj pointer to an object
 */
LV_EXPORT_API void lv_obj_refresh_ext_draw_pad(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_obj_get_screen(const lv_obj_t * obj);

/**
 * Get the display of an object
 * @return pointer the object's display
 */
LV_EXPORT_API lv_disp_t * lv_obj_get_disp(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_obj_get_parent(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_obj_get_child(const lv_obj_t * obj, const lv_obj_t * child);
 ...
 * @return the child after 'act_child' or NULL if no more child
 */
LV_EXPORT_API lv_obj_t * lv_obj_get_child_back(const lv_obj_t * obj, const lv_obj_t * child);
 ...
 */
LV_EXPORT_API uint16_t lv_obj_count_children(const lv_obj_t * obj);

/** Recursively count the children of an object
 * @param obj pointer to an object
 * @return children number of 'obj'
 */
LV_EXPORT_API uint16_t lv_obj_count_children_recursive(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_get_coords(const lv_obj_t * obj, lv_area_t * cords_p);
 ...
 */
LV_EXPORT_API void lv_obj_get_inner_coords(const lv_obj_t * obj, lv_area_t * coords_p);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_x(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_y(const lv_obj_t * obj);
 ...
 * @return the width
 */
LV_EXPORT_API lv_coord_t lv_obj_get_width(const lv_obj_t * obj);
 ...
 * @return the height
 */
LV_EXPORT_API lv_coord_t lv_obj_get_height(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_width_fit(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_height_fit(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_height_margin(lv_obj_t * obj);
 ...
 * @return the height including thee margins
 */
LV_EXPORT_API lv_coord_t lv_obj_get_width_margin(lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_width_grid(lv_obj_t * obj, uint8_t div, uint8_t span);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_height_grid(lv_obj_t * obj, uint8_t div, uint8_t span);
 ...
 */
LV_EXPORT_API bool lv_obj_get_auto_realign(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_ext_click_pad_left(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_ext_click_pad_right(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_ext_click_pad_top(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_ext_click_pad_bottom(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_ext_draw_pad(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_style_list_t * lv_obj_get_style_list(const lv_obj_t * obj, uint8_t part);
 ...
 * @note for performance reasons it's not checked if the property really has integer type
 */
LV_EXPORT_API lv_style_int_t _lv_obj_get_style_int(const lv_obj_t * obj, uint8_t part, lv_style_property_t prop);
 ...
 * @note for performance reasons it's not checked if the property really has color type
 */
LV_EXPORT_API lv_color_t _lv_obj_get_style_color(const lv_obj_t * obj, uint8_t part, lv_style_property_t prop);
 ...
 * @note for performance reasons it's not checked if the property really has opacity type
 */
LV_EXPORT_API lv_opa_t _lv_obj_get_style_opa(const lv_obj_t * obj, uint8_t part, lv_style_property_t prop);
 ...
 * @note for performance reasons it's not checked if the property really has pointer type
 */
LV_EXPORT_API const void * _lv_obj_get_style_ptr(const lv_obj_t * obj, uint8_t part, lv_style_property_t prop);

LV_EXPORT_API void _lv_obj_set_event_cb_interceptor(lv_obj_t* obj, lv_event_cb_interceptor_t interceptor, void *data);
 ...
 */
LV_EXPORT_API lv_style_t * lv_obj_get_local_style(lv_obj_t * obj, uint8_t part);
 ...
 */
LV_EXPORT_API bool lv_obj_get_hidden(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_adv_hittest(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_click(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_top(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_drag(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_drag_dir_t lv_obj_get_drag_dir(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_drag_throw(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_get_drag_parent(const lv_obj_t * obj);
...
*/
LV_EXPORT_API bool lv_obj_get_focus_parent(const lv_obj_t * obj);
 ...
 * @return true: drag parent is enabled
 */
LV_EXPORT_API bool lv_obj_get_parent_event(const lv_obj_t * obj);
...
*/
LV_EXPORT_API bool lv_obj_get_gesture_parent(const lv_obj_t * obj);

LV_EXPORT_API lv_bidi_dir_t lv_obj_get_base_dir(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API uint8_t lv_obj_get_protect(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_is_protected(const lv_obj_t * obj, uint8_t prot);

LV_EXPORT_API lv_state_t lv_obj_get_state(const lv_obj_t * obj, uint8_t part);
 ...
 */
LV_EXPORT_API lv_signal_cb_t lv_obj_get_signal_cb(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_design_cb_t lv_obj_get_design_cb(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_event_cb_t lv_obj_get_event_cb(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_is_point_on_coords(lv_obj_t * obj, const lv_point_t * point);
 ...
 */
LV_EXPORT_API bool lv_obj_hittest(lv_obj_t * obj, lv_point_t * point);
 ...
 */
LV_EXPORT_API void * lv_obj_get_ext_attr(const lv_obj_t * obj);

LV_EXPORT_API void * lv_obj_get_custom_view_data(const lv_obj_t* obj);
LV_EXPORT_API void lv_obj_set_custom_view_data(lv_obj_t* obj, void *data);
/**
 ...
 */
LV_EXPORT_API void lv_obj_get_type(const lv_obj_t * obj, lv_obj_type_t * buf);
 ...
 * @return user data
 */
LV_EXPORT_API lv_obj_user_data_t lv_obj_get_user_data(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_obj_user_data_t * lv_obj_get_user_data_ptr(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API void lv_obj_set_user_data(lv_obj_t * obj, lv_obj_user_data_t data);
 ...
 */
LV_EXPORT_API void * lv_obj_get_group(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API bool lv_obj_is_focused(const lv_obj_t * obj);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_obj_get_focused_obj(const lv_obj_t * obj);
 ...
 * @return LV_RES_OK
 */
LV_EXPORT_API lv_res_t lv_obj_handle_get_type_signal(lv_obj_type_t * buf, const char * name);
 ...
 */
LV_EXPORT_API void lv_obj_init_draw_rect_dsc(lv_obj_t * obj, uint8_t type, lv_draw_rect_dsc_t * draw_dsc);

LV_EXPORT_API void lv_obj_init_draw_label_dsc(lv_obj_t * obj, uint8_t type, lv_draw_label_dsc_t * draw_dsc);

LV_EXPORT_API void lv_obj_init_draw_img_dsc(lv_obj_t * obj, uint8_t part, lv_draw_img_dsc_t * draw_dsc);

LV_EXPORT_API void lv_obj_init_draw_line_dsc(lv_obj_t * obj, uint8_t part, lv_draw_line_dsc_t * draw_dsc);
 ...
 */
LV_EXPORT_API lv_coord_t lv_obj_get_draw_rect_ext_pad_size(lv_obj_t * obj, uint8_t part);
 ...
 */
LV_EXPORT_API void lv_obj_fade_in(lv_obj_t * obj, uint32_t time, uint32_t delay);
 ...
 * @param delay wait before the animation starts [ms]
 */
LV_EXPORT_API void lv_obj_fade_out(lv_obj_t * obj, uint32_t time, uint32_t delay);
 ...
 * @return true: valid
 */
LV_EXPORT_API bool lv_debug_check_obj_type(const lv_obj_t * obj, const char * obj_type);
 ...
 * @return true: valid
 */
LV_EXPORT_API bool lv_debug_check_obj_valid(const lv_obj_t * obj);
