 ...
 */
LV_EXPORT_API lv_obj_t * lv_objmask_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API lv_objmask_mask_t * lv_objmask_add_mask(lv_obj_t * objmask, void * param);
 ...
 */
LV_EXPORT_API void lv_objmask_update_mask(lv_obj_t * objmask, lv_objmask_mask_t * mask, void * param);
 ...
 */
LV_EXPORT_API void lv_objmask_remove_mask(lv_obj_t * objmask, lv_objmask_mask_t * mask);
