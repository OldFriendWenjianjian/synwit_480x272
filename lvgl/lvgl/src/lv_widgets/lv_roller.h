 ...
 */
LV_EXPORT_API lv_obj_t * lv_roller_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_roller_set_options(lv_obj_t * roller, const char * options, lv_roller_mode_t mode);
 ...
 */
LV_EXPORT_API void lv_roller_set_align(lv_obj_t * roller, lv_label_align_t align);
 ...
 */
LV_EXPORT_API void lv_roller_set_selected(lv_obj_t * roller, uint16_t sel_opt, lv_anim_enable_t anim);
 ...
 */
LV_EXPORT_API void lv_roller_set_visible_row_count(lv_obj_t * roller, uint8_t row_cnt);
 ...
 */
LV_EXPORT_API void lv_roller_set_auto_fit(lv_obj_t * roller, bool auto_fit);
 ...
 */
LV_EXPORT_API uint16_t lv_roller_get_selected(const lv_obj_t * roller);
 ...
 */
LV_EXPORT_API uint16_t lv_roller_get_option_cnt(const lv_obj_t * roller);
 ...
 */
LV_EXPORT_API void lv_roller_get_selected_str(const lv_obj_t * roller, char * buf, uint32_t buf_size);
 ...
 */
LV_EXPORT_API lv_label_align_t lv_roller_get_align(const lv_obj_t * roller);
 ...
 */
LV_EXPORT_API bool lv_roller_get_auto_fit(lv_obj_t * roller);
 ...
 */
LV_EXPORT_API const char * lv_roller_get_options(const lv_obj_t * roller);
