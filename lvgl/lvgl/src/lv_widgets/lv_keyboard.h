...
typedef uint8_t lv_keyboard_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_keyboard_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_keyboard_set_textarea(lv_obj_t * kb, lv_obj_t * ta);
 ...
 */
LV_EXPORT_API void lv_keyboard_set_mode(lv_obj_t * kb, lv_keyboard_mode_t mode);
 ...
 */
LV_EXPORT_API void lv_keyboard_set_cursor_manage(lv_obj_t * kb, bool en);
 ...
 */
LV_EXPORT_API void lv_keyboard_set_map(lv_obj_t * kb, lv_keyboard_mode_t mode, const char * map[]);
 ...
 */
LV_EXPORT_API void lv_keyboard_set_ctrl_map(lv_obj_t * kb, lv_keyboard_mode_t mode, const lv_btnmatrix_ctrl_t ctrl_map[]);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_keyboard_get_textarea(const lv_obj_t * kb);
 ...
 */
LV_EXPORT_API lv_keyboard_mode_t lv_keyboard_get_mode(const lv_obj_t * kb);
 ...
 */
LV_EXPORT_API bool lv_keyboard_get_cursor_manage(const lv_obj_t * kb);
 ...
 */
LV_EXPORT_API void lv_keyboard_def_event_cb(lv_obj_t * kb, lv_event_t event);
