...
typedef uint8_t lv_list_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_create(lv_obj_t * par, const lv_obj_t * copy);

/**
 * Delete all children of the scrl object, without deleting scrl child.
 * @param list pointer to an object
 */
LV_EXPORT_API void lv_list_clean(lv_obj_t * list);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_add_btn(lv_obj_t * list, const void * img_src, const char * txt);
 ...
 */
LV_EXPORT_API bool lv_list_remove(const lv_obj_t * list, uint16_t index);
 ...
 */
LV_EXPORT_API void lv_list_focus_btn(lv_obj_t * list, lv_obj_t * btn);
 ...
 */
LV_EXPORT_API void lv_list_set_layout(lv_obj_t * list, lv_layout_t layout);
 ...
 */
LV_EXPORT_API const char * lv_list_get_btn_text(const lv_obj_t * btn);
/**
 * Get the label object from a list element
 * @param btn pointer to a list element (button)
 * @return pointer to the label from the list element or NULL if not found
 */
LV_EXPORT_API lv_obj_t * lv_list_get_btn_label(const lv_obj_t * btn);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_get_btn_img(const lv_obj_t * btn);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_get_prev_btn(const lv_obj_t * list, lv_obj_t * prev_btn);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_get_next_btn(const lv_obj_t * list, lv_obj_t * prev_btn);
 ...
 */
LV_EXPORT_API int32_t lv_list_get_btn_index(const lv_obj_t * list, const lv_obj_t * btn);
 ...
 */
LV_EXPORT_API uint16_t lv_list_get_size(const lv_obj_t * list);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_list_get_btn_selected(const lv_obj_t * list);
#endif
 ...
 */
LV_EXPORT_API lv_layout_t lv_list_get_layout(lv_obj_t * list);
 ...
 */
LV_EXPORT_API void lv_list_up(const lv_obj_t * list);
/**
 * Move the list elements down by one
 * @param list pointer to a list object
 */
LV_EXPORT_API void lv_list_down(const lv_obj_t * list);
 ...
 */
LV_EXPORT_API void lv_list_focus(const lv_obj_t * btn, lv_anim_enable_t anim);
