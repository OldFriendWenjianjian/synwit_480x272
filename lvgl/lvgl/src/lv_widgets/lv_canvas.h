 ...
 */
LV_EXPORT_API lv_obj_t * lv_canvas_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_canvas_set_buffer(lv_obj_t * canvas, void * buf, lv_coord_t w, lv_coord_t h, lv_img_cf_t cf);
 ...
 */
LV_EXPORT_API void lv_canvas_set_px(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_color_t c);
 ...
 */
LV_EXPORT_API void lv_canvas_set_palette(lv_obj_t * canvas, uint8_t id, lv_color_t c);
 ...
 */
LV_EXPORT_API lv_color_t lv_canvas_get_px(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y);
 ...
 */
LV_EXPORT_API lv_img_dsc_t * lv_canvas_get_img(lv_obj_t * canvas);
 ...
 */
LV_EXPORT_API void lv_canvas_copy_buf(lv_obj_t * canvas, const void * to_copy, lv_coord_t x, lv_coord_t y, lv_coord_t w,
                        lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_canvas_transform(lv_obj_t * canvas, lv_img_dsc_t * img, int16_t angle, uint16_t zoom, lv_coord_t offset_x,
                         lv_coord_t offset_y,
 ...
 */
LV_EXPORT_API void lv_canvas_blur_hor(lv_obj_t * canvas, const lv_area_t * area, uint16_t r);
 ...
 * @param r radius of the blur
 */
LV_EXPORT_API void lv_canvas_blur_ver(lv_obj_t * canvas, const lv_area_t * area, uint16_t r);
 ...
 */
LV_EXPORT_API void lv_canvas_fill_bg(lv_obj_t * canvas, lv_color_t color, lv_opa_t opa);
 ...
 */
LV_EXPORT_API void lv_canvas_draw_rect(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t w, lv_coord_t h,
 ...
 */
LV_EXPORT_API void lv_canvas_draw_text(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t max_w,
 ...
 */
LV_EXPORT_API void lv_canvas_draw_img(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, const void * src,
 ...
 */
LV_EXPORT_API void lv_canvas_draw_line(lv_obj_t * canvas, const lv_point_t points[], uint32_t point_cnt,
 ...
 */
LV_EXPORT_API void lv_canvas_draw_polygon(lv_obj_t * canvas, const lv_point_t points[], uint32_t point_cnt,
 ...
 */
LV_EXPORT_API void lv_canvas_draw_arc(lv_obj_t * canvas, lv_coord_t x, lv_coord_t y, lv_coord_t r, int32_t start_angle,
