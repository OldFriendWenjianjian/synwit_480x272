 ...
 */
LV_EXPORT_API lv_obj_t * lv_win_create(lv_obj_t * par, const lv_obj_t * copy);

/**
 * Delete all children of the scrl object, without deleting scrl child.
 * @param win pointer to an object
 */
LV_EXPORT_API void lv_win_clean(lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_win_add_btn_right(lv_obj_t * win, const void * img_src);
 ...
 * @return pointer to the created button object
 */
LV_EXPORT_API lv_obj_t * lv_win_add_btn_left(lv_obj_t * win, const void * img_src);
 ...
 */
LV_EXPORT_API void lv_win_close_event_cb(lv_obj_t * btn, lv_event_t event);
 ...
 */
LV_EXPORT_API void lv_win_set_title(lv_obj_t * win, const char * title);
 ...
 */
LV_EXPORT_API void lv_win_set_header_height(lv_obj_t * win, lv_coord_t size);
 ...
 */
LV_EXPORT_API void lv_win_set_btn_width(lv_obj_t * win, lv_coord_t width);
 ...
 */
LV_EXPORT_API void lv_win_set_content_size(lv_obj_t * win, lv_coord_t w, lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_win_set_layout(lv_obj_t * win, lv_layout_t layout);
 ...
 */
LV_EXPORT_API void lv_win_set_scrollbar_mode(lv_obj_t * win, lv_scrollbar_mode_t sb_mode);
 ...
 */
LV_EXPORT_API void lv_win_set_anim_time(lv_obj_t * win, uint16_t anim_time);
 ...
 */
LV_EXPORT_API void lv_win_set_drag(lv_obj_t * win, bool en);
 ...
 */
LV_EXPORT_API void lv_win_title_set_alignment(lv_obj_t * win, uint8_t alignment);
 ...
 */
LV_EXPORT_API const char * lv_win_get_title(const lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_win_get_content(const lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_coord_t lv_win_get_header_height(const lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_coord_t lv_win_get_btn_width(lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_win_get_from_btn(const lv_obj_t * ctrl_btn);
 ...
 */
LV_EXPORT_API lv_layout_t lv_win_get_layout(lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_scrollbar_mode_t lv_win_get_sb_mode(lv_obj_t * win);
 ...
 */
LV_EXPORT_API uint16_t lv_win_get_anim_time(const lv_obj_t * win);
 ...
 */
LV_EXPORT_API lv_coord_t lv_win_get_width(lv_obj_t * win);
 ...
 * @param win pointer to a window object
 */
LV_EXPORT_API uint8_t lv_win_title_get_alignment(lv_obj_t * win);
 ...
 */
LV_EXPORT_API void lv_win_focus(lv_obj_t * win, lv_obj_t * obj, lv_anim_enable_t anim_en);
