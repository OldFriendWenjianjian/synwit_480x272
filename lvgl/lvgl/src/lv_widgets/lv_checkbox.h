...
typedef uint8_t lv_checkbox_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_checkbox_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_checkbox_set_text(lv_obj_t * cb, const char * txt);
 ...
 * @param txt the text of the check box. NULL to refresh with the current text.
 */
LV_EXPORT_API void lv_checkbox_set_text_static(lv_obj_t * cb, const char * txt);
 ...
 */
LV_EXPORT_API void lv_checkbox_set_checked(lv_obj_t * cb, bool checked);

/**
 * Make the check box inactive (disabled)
 * @param cb pointer to a check box object
 */
LV_EXPORT_API void lv_checkbox_set_disabled(lv_obj_t * cb);
 ...
 */
LV_EXPORT_API void lv_checkbox_set_state(lv_obj_t * cb, lv_btn_state_t state);
/*=====================
 * Getter functions
 *====================*/
 ...
 */
LV_EXPORT_API const char * lv_checkbox_get_text(const lv_obj_t * cb);
