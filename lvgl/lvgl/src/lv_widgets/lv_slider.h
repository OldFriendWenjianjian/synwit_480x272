...
typedef uint8_t lv_slider_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_slider_create(lv_obj_t * par, const lv_obj_t * copy);
...
{
    int16_t old_value = lv_bar_get_value(slider);
 ...
 */
LV_EXPORT_API int16_t lv_slider_get_value(const lv_obj_t * slider);
 ...
 */
LV_EXPORT_API bool lv_slider_is_dragged(const lv_obj_t * slider);
