...
typedef uint8_t lv_msgbox_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_msgbox_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_msgbox_add_btns(lv_obj_t * mbox, const char * btn_mapaction[]);
 ...
 */
LV_EXPORT_API void lv_msgbox_set_text(lv_obj_t * mbox, const char * txt);
 ...
 */
LV_EXPORT_API void lv_msgbox_set_text_fmt(lv_obj_t * mbox, const char * fmt, ...);
 ...
 */
LV_EXPORT_API void lv_msgbox_set_anim_time(lv_obj_t * mbox, uint16_t anim_time);
 ...
 */
LV_EXPORT_API void lv_msgbox_start_auto_close(lv_obj_t * mbox, uint16_t delay);

/**
 * Stop the auto. closing of message box
 * @param mbox pointer to a message box object
 */
LV_EXPORT_API void lv_msgbox_stop_auto_close(lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API void lv_msgbox_set_recolor(lv_obj_t * mbox, bool en);
 ...
 */
LV_EXPORT_API const char * lv_msgbox_get_text(const lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API uint16_t lv_msgbox_get_active_btn(lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API const char * lv_msgbox_get_active_btn_text(lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API uint16_t lv_msgbox_get_anim_time(const lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API bool lv_msgbox_get_recolor(const lv_obj_t * mbox);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_msgbox_get_btnmatrix(lv_obj_t * mbox);
