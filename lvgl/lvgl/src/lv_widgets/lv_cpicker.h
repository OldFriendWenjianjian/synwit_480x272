...
typedef uint8_t lv_cpicker_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_cpicker_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_cpicker_set_type(lv_obj_t * cpicker, lv_cpicker_type_t type);
 ...
 */
LV_EXPORT_API bool lv_cpicker_set_hue(lv_obj_t * cpicker, uint16_t hue);
 ...
 * @return true if changed, otherwise false
 */
LV_EXPORT_API bool lv_cpicker_set_saturation(lv_obj_t * cpicker, uint8_t saturation);
 ...
 * @return true if changed, otherwise false
 */
LV_EXPORT_API bool lv_cpicker_set_value(lv_obj_t * cpicker, uint8_t val);
 ...
 * @return true if changed, otherwise false
 */
LV_EXPORT_API bool lv_cpicker_set_hsv(lv_obj_t * cpicker, lv_color_hsv_t hsv);
 ...
 * @return true if changed, otherwise false
 */
LV_EXPORT_API bool lv_cpicker_set_color(lv_obj_t * cpicker, lv_color_t color);
 ...
 */
LV_EXPORT_API void lv_cpicker_set_color_mode(lv_obj_t * cpicker, lv_cpicker_color_mode_t mode);
 ...
 */
LV_EXPORT_API void lv_cpicker_set_color_mode_fixed(lv_obj_t * cpicker, bool fixed);
 ...
 */
LV_EXPORT_API void lv_cpicker_set_knob_colored(lv_obj_t * cpicker, bool en);
 ...
 */
LV_EXPORT_API lv_cpicker_color_mode_t lv_cpicker_get_color_mode(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API bool lv_cpicker_get_color_mode_fixed(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API uint16_t lv_cpicker_get_hue(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API uint8_t lv_cpicker_get_saturation(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API uint8_t lv_cpicker_get_value(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API lv_color_hsv_t lv_cpicker_get_hsv(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API lv_color_t lv_cpicker_get_color(lv_obj_t * cpicker);
 ...
 */
LV_EXPORT_API bool lv_cpicker_get_knob_colored(lv_obj_t * cpicker);
