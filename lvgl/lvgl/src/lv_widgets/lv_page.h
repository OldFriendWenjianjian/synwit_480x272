...
typedef uint8_t lv_page_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_page_create(lv_obj_t * par, const lv_obj_t * copy);

/**
 * Delete all children of the scrl object, without deleting scrl child.
 * @param page pointer to an object
 */
LV_EXPORT_API void lv_page_clean(lv_obj_t * page);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_page_get_scrollable(const lv_obj_t * page);
 ...
 */
LV_EXPORT_API uint16_t lv_page_get_anim_time(const lv_obj_t * page);
 ...
 */
LV_EXPORT_API void lv_page_set_scrollbar_mode(lv_obj_t * page, lv_scrollbar_mode_t sb_mode);
 ...
 */
LV_EXPORT_API void lv_page_set_anim_time(lv_obj_t * page, uint16_t anim_time);
 ...
 */
LV_EXPORT_API void lv_page_set_scroll_propagation(lv_obj_t * page, bool en);
 ...
 */
LV_EXPORT_API void lv_page_set_edge_flash(lv_obj_t * page, bool en);
 ...
 */
LV_EXPORT_API lv_scrollbar_mode_t lv_page_get_scrollbar_mode(const lv_obj_t * page);
 ...
 */
LV_EXPORT_API bool lv_page_get_scroll_propagation(lv_obj_t * page);
 ...
 * return true or false
 */
LV_EXPORT_API bool lv_page_get_edge_flash(lv_obj_t * page);
 ...
 */
LV_EXPORT_API lv_coord_t lv_page_get_width_fit(lv_obj_t * page);
 ...
 */
LV_EXPORT_API lv_coord_t lv_page_get_height_fit(lv_obj_t * page);
 ...
 */
LV_EXPORT_API lv_coord_t lv_page_get_width_grid(lv_obj_t * page, uint8_t div, uint8_t span);
 ...
 */
LV_EXPORT_API lv_coord_t lv_page_get_height_grid(lv_obj_t * page, uint8_t div, uint8_t span);
 ...
 */
LV_EXPORT_API bool lv_page_on_edge(lv_obj_t * page, lv_page_edge_t edge);
 ...
 */
LV_EXPORT_API void lv_page_glue_obj(lv_obj_t * obj, bool glue);
 ...
 */
LV_EXPORT_API void lv_page_focus(lv_obj_t * page, const lv_obj_t * obj, lv_anim_enable_t anim_en);
 ...
 */
LV_EXPORT_API void lv_page_scroll_hor(lv_obj_t * page, lv_coord_t dist);
 ...
 */
LV_EXPORT_API void lv_page_scroll_ver(lv_obj_t * page, lv_coord_t dist);
 ...
 */
LV_EXPORT_API void lv_page_start_edge_flash(lv_obj_t * page, lv_page_edge_t edge);
