 ...
 */
LV_EXPORT_API lv_obj_t * lv_label_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_label_set_text(lv_obj_t * label, const char * text);
 ...
 */
LV_EXPORT_API void lv_label_set_text_fmt(lv_obj_t * label, const char * fmt, ...);
 ...
 */
LV_EXPORT_API void lv_label_set_text_static(lv_obj_t * label, const char * text);
 ...
 * function
 */
LV_EXPORT_API void lv_label_set_long_mode(lv_obj_t * label, lv_label_long_mode_t long_mode);
 ...
 */
LV_EXPORT_API void lv_label_set_align(lv_obj_t * label, lv_label_align_t align);
 ...
 */
LV_EXPORT_API void lv_label_set_recolor(lv_obj_t * label, bool en);
 ...
 */
LV_EXPORT_API void lv_label_set_anim_speed(lv_obj_t * label, uint16_t anim_speed);
 ...
 */
LV_EXPORT_API void lv_label_set_text_sel_start(lv_obj_t * label, uint32_t index);
 ...
 * @param index index to set. `LV_LABEL_TXT_SEL_OFF` to select nothing.
 */
LV_EXPORT_API void lv_label_set_text_sel_end(lv_obj_t * label, uint32_t index);
/*=====================
 * Getter functions
 *====================*/
 ...
 */
LV_EXPORT_API char * lv_label_get_text(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API lv_label_long_mode_t lv_label_get_long_mode(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API lv_label_align_t lv_label_get_align(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API bool lv_label_get_recolor(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API uint16_t lv_label_get_anim_speed(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API void lv_label_get_letter_pos(const lv_obj_t * label, uint32_t index, lv_point_t * pos);
 ...
 */
LV_EXPORT_API uint32_t lv_label_get_letter_on(const lv_obj_t * label, lv_point_t * pos);
 ...
 */
LV_EXPORT_API bool lv_label_is_char_under_pos(const lv_obj_t * label, lv_point_t * pos);
 ...
 */
LV_EXPORT_API uint32_t lv_label_get_text_sel_start(const lv_obj_t * label);
 ...
 */
LV_EXPORT_API uint32_t lv_label_get_text_sel_end(const lv_obj_t * label);

LV_EXPORT_API lv_style_list_t * lv_label_get_style(lv_obj_t * label, uint8_t type);
 ...
 */
LV_EXPORT_API void lv_label_ins_text(lv_obj_t * label, uint32_t pos, const char * txt);
 ...
 */
LV_EXPORT_API void lv_label_cut_text(lv_obj_t * label, uint32_t pos, uint32_t cnt);

/**
 * Refresh the label with its text stored in its extended data
 * @param label pointer to a label object
 */
LV_EXPORT_API void lv_label_refr_text(lv_obj_t * label);
