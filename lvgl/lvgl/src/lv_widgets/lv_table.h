...
typedef uint8_t lv_table_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_table_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_value(lv_obj_t * table, uint16_t row, uint16_t col, const char * txt);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_value_fmt(lv_obj_t * table, uint16_t row, uint16_t col, const char * fmt, ...);
 ...
 */
LV_EXPORT_API void lv_table_set_row_cnt(lv_obj_t * table, uint16_t row_cnt);
 ...
 */
LV_EXPORT_API void lv_table_set_col_cnt(lv_obj_t * table, uint16_t col_cnt);
 ...
 */
LV_EXPORT_API void lv_table_set_col_width(lv_obj_t * table, uint16_t col_id, lv_coord_t w);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_align(lv_obj_t * table, uint16_t row, uint16_t col, lv_label_align_t align);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_type(lv_obj_t * table, uint16_t row, uint16_t col, uint8_t type);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_crop(lv_obj_t * table, uint16_t row, uint16_t col, bool crop);
 ...
 */
LV_EXPORT_API void lv_table_set_cell_merge_right(lv_obj_t * table, uint16_t row, uint16_t col, bool en);
 ...
 */
LV_EXPORT_API const char * lv_table_get_cell_value(lv_obj_t * table, uint16_t row, uint16_t col);
 ...
 */
LV_EXPORT_API uint16_t lv_table_get_row_cnt(lv_obj_t * table);
 ...
 */
LV_EXPORT_API uint16_t lv_table_get_col_cnt(lv_obj_t * table);
 ...
 */
LV_EXPORT_API lv_coord_t lv_table_get_col_width(lv_obj_t * table, uint16_t col_id);
 ...
 */
LV_EXPORT_API lv_label_align_t lv_table_get_cell_align(lv_obj_t * table, uint16_t row, uint16_t col);
 ...
 * @return 1,2,3 or 4
 */
LV_EXPORT_API lv_label_align_t lv_table_get_cell_type(lv_obj_t * table, uint16_t row, uint16_t col);
 ...
 */
LV_EXPORT_API lv_label_align_t lv_table_get_cell_crop(lv_obj_t * table, uint16_t row, uint16_t col);
 ...
 */
LV_EXPORT_API bool lv_table_get_cell_merge_right(lv_obj_t * table, uint16_t row, uint16_t col);
 ...
 */
LV_EXPORT_API lv_res_t lv_table_get_pressed_cell(lv_obj_t * table, uint16_t * row, uint16_t * col);
