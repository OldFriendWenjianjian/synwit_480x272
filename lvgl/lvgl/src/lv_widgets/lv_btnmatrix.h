 ...
 */
LV_EXPORT_API lv_obj_t * lv_btnmatrix_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_map(lv_obj_t * btnm, const char * map[]);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_ctrl_map(lv_obj_t * btnm, const lv_btnmatrix_ctrl_t ctrl_map[]);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_focused_btn(lv_obj_t * btnm, uint16_t id);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_recolor(const lv_obj_t * btnm, bool en);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_btn_ctrl(lv_obj_t * btnm, uint16_t btn_id, lv_btnmatrix_ctrl_t ctrl);
 ...
 * @param btn_id 0 based index of the button to modify. (Not counting new lines)
 */
LV_EXPORT_API void lv_btnmatrix_clear_btn_ctrl(const lv_obj_t * btnm, uint16_t btn_id, lv_btnmatrix_ctrl_t ctrl);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_btn_ctrl_all(lv_obj_t * btnm, lv_btnmatrix_ctrl_t ctrl);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_clear_btn_ctrl_all(lv_obj_t * btnm, lv_btnmatrix_ctrl_t ctrl);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_btn_width(lv_obj_t * btnm, uint16_t btn_id, uint8_t width);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_one_check(lv_obj_t * btnm, bool one_chk);
 ...
 */
LV_EXPORT_API void lv_btnmatrix_set_align(lv_obj_t * btnm, lv_label_align_t align);
 ...
 */
LV_EXPORT_API const char ** lv_btnmatrix_get_map_array(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API bool lv_btnmatrix_get_recolor(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API uint16_t lv_btnmatrix_get_active_btn(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API const char * lv_btnmatrix_get_active_btn_text(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API uint16_t lv_btnmatrix_get_focused_btn(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API const char * lv_btnmatrix_get_btn_text(const lv_obj_t * btnm, uint16_t btn_id);
 ...
 */
LV_EXPORT_API bool lv_btnmatrix_get_btn_ctrl(lv_obj_t * btnm, uint16_t btn_id, lv_btnmatrix_ctrl_t ctrl);
 ...
 */
LV_EXPORT_API bool lv_btnmatrix_get_one_check(const lv_obj_t * btnm);
 ...
 */
LV_EXPORT_API lv_label_align_t lv_btnmatrix_get_align(const lv_obj_t * btnm);
