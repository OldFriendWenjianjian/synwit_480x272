...
typedef uint8_t lv_line_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_line_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_line_set_points(lv_obj_t * line, const lv_point_t point_a[], uint16_t point_num);
 ...
 */
LV_EXPORT_API void lv_line_set_auto_size(lv_obj_t * line, bool en);
 ...
 */
LV_EXPORT_API void lv_line_set_y_invert(lv_obj_t * line, bool en);
 ...
 */
LV_EXPORT_API bool lv_line_get_auto_size(const lv_obj_t * line);
 ...
 */
LV_EXPORT_API bool lv_line_get_y_invert(const lv_obj_t * line);
