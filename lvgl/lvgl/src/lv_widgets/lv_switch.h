 ...
 */
LV_EXPORT_API lv_obj_t * lv_switch_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_switch_on(lv_obj_t * sw, lv_anim_enable_t anim);
 ...
 * @param anim LV_ANIM_ON: set the value with an animation; LV_ANIM_OFF: change the value immediately
 */
LV_EXPORT_API void lv_switch_off(lv_obj_t * sw, lv_anim_enable_t anim);
 ...
 */
LV_EXPORT_API bool lv_switch_toggle(lv_obj_t * sw, lv_anim_enable_t anim);
