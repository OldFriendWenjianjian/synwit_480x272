...
typedef uint8_t lv_tileview_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_tileview_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_tileview_add_element(lv_obj_t * tileview, lv_obj_t * element);
 ...
 */
LV_EXPORT_API void lv_tileview_set_valid_positions(lv_obj_t * tileview, const lv_point_t valid_pos[], uint16_t valid_pos_cnt);
 ...
 */
LV_EXPORT_API void lv_tileview_set_tile_act(lv_obj_t * tileview, lv_coord_t x, lv_coord_t y, lv_anim_enable_t anim);
LV_EXPORT_API void lv_tileview_set_tile_act_by_index(lv_obj_t* tileview, int16_t tile_index, lv_anim_enable_t anim);
...
//}
LV_EXPORT_API void lv_tileview_set_anim_time(lv_obj_t* tileview, uint16_t anim_time);

/**
 * Enable the remap mode
 * @param tileview pointer to a page object
 * @param en true or false to enable/disable remap mode
 */
LV_EXPORT_API void lv_tileview_set_remap_mode(lv_obj_t* tileview, bool en);
LV_EXPORT_API void lv_tileview_set_ramap_range(lv_obj_t* tileview, uint16_t start_pos, uint16_t end_pos);
/*=====================
 * Getter functions
 *====================*/
/**
...
* @param y line id (0, 1, 2...)
*/
LV_EXPORT_API void lv_tileview_get_tile_act(lv_obj_t * tileview, lv_coord_t * x, lv_coord_t * y);
/**
