 ...
 */
LV_EXPORT_API lv_obj_t * lv_btn_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_btn_set_checkable(lv_obj_t * btn, bool tgl);
 ...
 */
LV_EXPORT_API void lv_btn_set_state(lv_obj_t * btn, lv_btn_state_t state);

/**
 * Toggle the state of the button (ON->OFF, OFF->ON)
 * @param btn pointer to a button object
 */
LV_EXPORT_API void lv_btn_toggle(lv_obj_t * btn);
 ...
 */
LV_EXPORT_API lv_btn_state_t lv_btn_get_state(const lv_obj_t * btn);
 ...
 */
LV_EXPORT_API bool lv_btn_get_checkable(const lv_obj_t * btn);
