 ...
 */
LV_EXPORT_API lv_obj_t * lv_calendar_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_calendar_set_today_date(lv_obj_t * calendar, lv_calendar_date_t * today);
 ...
 * will be saved it can be local variable too.
 */
LV_EXPORT_API void lv_calendar_set_showed_date(lv_obj_t * calendar, lv_calendar_date_t * showed);
 ...
 */
LV_EXPORT_API void lv_calendar_set_highlighted_dates(lv_obj_t * calendar, lv_calendar_date_t highlighted[], uint16_t date_num);
 ...
 * later.
 */
LV_EXPORT_API void lv_calendar_set_day_names(lv_obj_t * calendar, const char ** day_names);
 ...
 * later.
 */
LV_EXPORT_API void lv_calendar_set_month_names(lv_obj_t * calendar, const char ** month_names);
 ...
 */
LV_EXPORT_API lv_calendar_date_t * lv_calendar_get_today_date(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API lv_calendar_date_t * lv_calendar_get_showed_date(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API lv_calendar_date_t * lv_calendar_get_pressed_date(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API lv_calendar_date_t * lv_calendar_get_highlighted_dates(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API uint16_t lv_calendar_get_highlighted_dates_num(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API const char ** lv_calendar_get_day_names(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API const char ** lv_calendar_get_month_names(const lv_obj_t * calendar);
 ...
 */
LV_EXPORT_API uint8_t lv_calendar_get_day_of_week(uint32_t year, uint32_t month, uint32_t day);
