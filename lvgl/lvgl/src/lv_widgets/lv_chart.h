...
typedef uint8_t lv_chart_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_chart_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API lv_chart_series_t * lv_chart_add_series(lv_obj_t * chart, lv_color_t color);
 ...
 */
LV_EXPORT_API void lv_chart_remove_series(lv_obj_t * chart, lv_chart_series_t * series);
 ...
 */
LV_EXPORT_API lv_chart_cursor_t * lv_chart_add_cursor(lv_obj_t * chart, lv_color_t color, lv_cursor_direction_t dir);
 ...
 */
LV_EXPORT_API void lv_chart_clear_series(lv_obj_t * chart, lv_chart_series_t * series);
 ...
 */
LV_EXPORT_API void lv_chart_hide_series(lv_obj_t * chart, lv_chart_series_t * series, bool hide);
 ...
 */
LV_EXPORT_API void lv_chart_set_div_line_count(lv_obj_t * chart, uint8_t hdiv, uint8_t vdiv);
 ...
 */
LV_EXPORT_API void lv_chart_set_y_range(lv_obj_t * chart, lv_chart_axis_t axis, lv_coord_t ymin, lv_coord_t ymax);
 ...
 */
LV_EXPORT_API void lv_chart_set_type(lv_obj_t * chart, lv_chart_type_t type);
 ...
 */
LV_EXPORT_API void lv_chart_set_point_count(lv_obj_t * chart, uint16_t point_cnt);
 ...
 */
LV_EXPORT_API void lv_chart_init_points(lv_obj_t * chart, lv_chart_series_t * ser, lv_coord_t y);
 ...
 */
LV_EXPORT_API void lv_chart_set_points(lv_obj_t * chart, lv_chart_series_t * ser, lv_coord_t y_array[]);
 ...
 */
LV_EXPORT_API void lv_chart_set_next(lv_obj_t * chart, lv_chart_series_t * ser, lv_coord_t y);
 ...
 * @param update mode
 */
LV_EXPORT_API void lv_chart_set_update_mode(lv_obj_t * chart, lv_chart_update_mode_t update_mode);
 ...
 */
LV_EXPORT_API void lv_chart_set_x_tick_length(lv_obj_t * chart, uint8_t major_tick_len, uint8_t minor_tick_len);
 ...
 *                       (where no labels are added)
 */
LV_EXPORT_API void lv_chart_set_y_tick_length(lv_obj_t * chart, uint8_t major_tick_len, uint8_t minor_tick_len);
 ...
 *                       (where no labels are added)
 */
LV_EXPORT_API void lv_chart_set_secondary_y_tick_length(lv_obj_t * chart, uint8_t major_tick_len, uint8_t minor_tick_len);
 ...
 */
LV_EXPORT_API void lv_chart_set_x_tick_texts(lv_obj_t * chart, const char * list_of_values, uint8_t num_tick_marks,
                               lv_chart_axis_options_t options);
 ...
 * @param options           extra options
 */
LV_EXPORT_API void lv_chart_set_secondary_y_tick_texts(lv_obj_t * chart, const char * list_of_values, uint8_t num_tick_marks,
                                         lv_chart_axis_options_t options);
 ...
 * @param options           extra options
 */
LV_EXPORT_API void lv_chart_set_y_tick_texts(lv_obj_t * chart, const char * list_of_values, uint8_t num_tick_marks,
                               lv_chart_axis_options_t options);
 ...
 */
LV_EXPORT_API void lv_chart_set_x_start_point(lv_obj_t * chart, lv_chart_series_t * ser, uint16_t id);
 ...
 */
LV_EXPORT_API void lv_chart_set_ext_array(lv_obj_t * chart, lv_chart_series_t * ser, lv_coord_t array[], uint16_t point_cnt);
 ...
 */
LV_EXPORT_API void lv_chart_set_point_id(lv_obj_t * chart, lv_chart_series_t * ser, lv_coord_t value, uint16_t id);
 ...
 * @param axis `LV_CHART_AXIS_PRIMARY_Y` or `LV_CHART_AXIS_SECONDARY_Y`
 */
LV_EXPORT_API void lv_chart_set_series_axis(lv_obj_t * chart, lv_chart_series_t * ser, lv_chart_axis_t axis);
 ...
 */
LV_EXPORT_API void lv_chart_set_cursor_point(lv_obj_t * chart, lv_chart_cursor_t * cursor, lv_point_t * point);
 ...
 */
LV_EXPORT_API lv_chart_type_t lv_chart_get_type(const lv_obj_t * chart);
 ...
 */
LV_EXPORT_API uint16_t lv_chart_get_point_count(const lv_obj_t * chart);
 ...
 */
LV_EXPORT_API uint16_t lv_chart_get_x_start_point(lv_chart_series_t * ser);
 ...
 */
LV_EXPORT_API lv_coord_t lv_chart_get_point_id(lv_obj_t * chart, lv_chart_series_t * ser, uint16_t id);
 ...
 */
LV_EXPORT_API lv_chart_axis_t lv_chart_get_series_axis(lv_obj_t * chart, lv_chart_series_t * ser);
 ...
 */
LV_EXPORT_API void lv_chart_get_series_area(lv_obj_t * chart, lv_area_t * series_area);
 ...
 */
LV_EXPORT_API lv_point_t lv_chart_get_cursor_point(lv_obj_t * chart, lv_chart_cursor_t * cursor);
 ...
 */
LV_EXPORT_API uint16_t lv_chart_get_nearest_index_from_coord(lv_obj_t * chart, lv_coord_t x);
 ...
 */
LV_EXPORT_API lv_coord_t lv_chart_get_x_from_index(lv_obj_t * chart, lv_chart_series_t * ser, uint16_t id);
 ...
 */
LV_EXPORT_API lv_coord_t lv_chart_get_y_from_index(lv_obj_t * chart, lv_chart_series_t * ser, uint16_t id);
 ...
 * @param chart pointer to chart object
 */
LV_EXPORT_API void lv_chart_refresh(lv_obj_t * chart);
