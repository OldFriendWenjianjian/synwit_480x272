...
typedef uint8_t lv_gauge_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_gauge_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_gauge_set_needle_count(lv_obj_t * gauge, uint8_t needle_cnt, const lv_color_t colors[]);
 ...
 */
LV_EXPORT_API void lv_gauge_set_value(lv_obj_t * gauge, uint8_t needle_id, int32_t value);
 ...
 */
LV_EXPORT_API void lv_gauge_set_scale(lv_obj_t * gauge, uint16_t angle, uint8_t line_cnt, uint8_t label_cnt);
 ...
 */
LV_EXPORT_API void lv_gauge_set_needle_img(lv_obj_t * gauge, const void * img, lv_coord_t pivot_x, lv_coord_t pivot_y);
 ...
 */
LV_EXPORT_API void lv_gauge_set_formatter_cb(lv_obj_t * gauge, lv_gauge_format_cb_t format_cb);
 ...
 */
LV_EXPORT_API int32_t lv_gauge_get_value(const lv_obj_t * gauge, uint8_t needle);
 ...
 */
LV_EXPORT_API uint8_t lv_gauge_get_needle_count(const lv_obj_t * gauge);
 ...
 */
LV_EXPORT_API uint8_t lv_gauge_get_label_count(const lv_obj_t * gauge);
 ...
 */
LV_EXPORT_API const void * lv_gauge_get_needle_img(lv_obj_t * gauge);
 ...
 */
LV_EXPORT_API lv_coord_t lv_gauge_get_needle_img_pivot_x(lv_obj_t * gauge);
 ...
 * @return the X coordinate of rotation center of the image
 */
LV_EXPORT_API lv_coord_t lv_gauge_get_needle_img_pivot_y(lv_obj_t * gauge);
