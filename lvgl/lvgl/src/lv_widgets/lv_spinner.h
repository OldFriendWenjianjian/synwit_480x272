...
typedef uint8_t lv_spinner_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_spinner_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_spinner_set_arc_length(lv_obj_t * spinner, lv_anim_value_t deg);
 ...
 */
LV_EXPORT_API void lv_spinner_set_spin_time(lv_obj_t * spinner, uint16_t time);
 ...
 *  */
LV_EXPORT_API void lv_spinner_set_type(lv_obj_t * spinner, lv_spinner_type_t type);
 ...
 */
LV_EXPORT_API void lv_spinner_set_dir(lv_obj_t * spinner, lv_spinner_dir_t dir);
 ...
 * @param spinner pointer to a spinner object
 */
LV_EXPORT_API lv_anim_value_t lv_spinner_get_arc_length(const lv_obj_t * spinner);

/**
 * Get the spin time of the arc
 * @param spinner pointer to a spinner object [milliseconds]
 */
LV_EXPORT_API uint16_t lv_spinner_get_spin_time(const lv_obj_t * spinner);
 ...
 *  */
LV_EXPORT_API lv_spinner_type_t lv_spinner_get_type(lv_obj_t * spinner);
 ...
 */
LV_EXPORT_API lv_spinner_dir_t lv_spinner_get_dir(lv_obj_t * spinner);
 ...
 */
LV_EXPORT_API void lv_spinner_anim_cb(void * ptr, lv_anim_value_t val);
