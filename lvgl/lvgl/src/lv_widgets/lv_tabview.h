 ...
 */
LV_EXPORT_API lv_obj_t * lv_tabview_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_tabview_add_tab(lv_obj_t * tabview, const char * name);

/**
 * Delete all children of a tab created by `lv_tabview_add_tab`.
 * @param tab pointer to a tab
 */
LV_EXPORT_API void lv_tabview_clean_tab(lv_obj_t * tab);
 ...
 */
LV_EXPORT_API void lv_tabview_set_tab_act(lv_obj_t * tabview, uint16_t id, lv_anim_enable_t anim);
 ...
 */
LV_EXPORT_API void lv_tabview_set_tab_name(lv_obj_t * tabview, uint16_t id, char * name);
 ...
 */
LV_EXPORT_API void lv_tabview_set_anim_time(lv_obj_t * tabview, uint16_t anim_time);
 ...
 */
LV_EXPORT_API void lv_tabview_set_btns_pos(lv_obj_t * tabview, lv_tabview_btns_pos_t btns_pos);
 ...
 */
LV_EXPORT_API uint16_t lv_tabview_get_tab_act(const lv_obj_t * tabview);
 ...
 * @return tab count
 */
LV_EXPORT_API uint16_t lv_tabview_get_tab_count(const lv_obj_t * tabview);
/**
 ...
 */
LV_EXPORT_API lv_obj_t * lv_tabview_get_tab(const lv_obj_t * tabview, uint16_t id);
 ...
 */
LV_EXPORT_API uint16_t lv_tabview_get_anim_time(const lv_obj_t * tabview);

/**
 * Get position of tab select buttons
 * @param tabview pointer to a ab view object
 */
LV_EXPORT_API lv_tabview_btns_pos_t lv_tabview_get_btns_pos(const lv_obj_t * tabview);
