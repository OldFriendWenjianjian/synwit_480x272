 ...
 */
LV_EXPORT_API lv_obj_t * lv_spinbox_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_spinbox_set_rollover(lv_obj_t * spinbox, bool b);
 ...
 */
LV_EXPORT_API void lv_spinbox_set_value(lv_obj_t * spinbox, int32_t i);
 ...
 * shown
 */
LV_EXPORT_API void lv_spinbox_set_digit_format(lv_obj_t * spinbox, uint8_t digit_count, uint8_t separator_position);
 ...
 */
LV_EXPORT_API void lv_spinbox_set_step(lv_obj_t * spinbox, uint32_t step);
 ...
 */
LV_EXPORT_API void lv_spinbox_set_range(lv_obj_t * spinbox, int32_t range_min, int32_t range_max);
 ...
 */
LV_EXPORT_API void lv_spinbox_set_padding_left(lv_obj_t * spinbox, uint8_t padding);
 ...
 * @param spinbox pointer to spinbox
 */
LV_EXPORT_API bool lv_spinbox_get_rollover(lv_obj_t * spinbox);
 ...
 */
LV_EXPORT_API int32_t lv_spinbox_get_value(lv_obj_t * spinbox);
 ...
 * @param spinbox pointer to spinbox
 */
LV_EXPORT_API void lv_spinbox_step_next(lv_obj_t * spinbox);

/**
 * Select next higher digit for edition by multiplying the step by 10
 * @param spinbox pointer to spinbox
 */
LV_EXPORT_API void lv_spinbox_step_prev(lv_obj_t * spinbox);

/**
 * Increment spinbox value by one step
 * @param spinbox pointer to spinbox
 */
LV_EXPORT_API void lv_spinbox_increment(lv_obj_t * spinbox);

/**
 * Decrement spinbox value by one step
 * @param spinbox pointer to spinbox
 */
LV_EXPORT_API void lv_spinbox_decrement(lv_obj_t * spinbox);
