...
typedef struct {
    ...
    lv_coord_t img_w; /*Width of the image map*/
    lv_coord_t img_h; /*Height of the image map*/

    /*Recolor*/
    lv_color_t recolor[_LV_BTN_STATE_LAST];
    lv_opa_t recolor_opa[_LV_BTN_STATE_LAST];
} lv_imgbtn_ext_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_imgbtn_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_imgbtn_set_src(lv_obj_t * imgbtn, lv_btn_state_t state, const void * src);

LV_EXPORT_API void lv_imgbtn_set_recolor(lv_obj_t* imgbtn, lv_btn_state_t state, lv_color_t recolor);
LV_EXPORT_API void lv_imgbtn_set_recolor_opa(lv_obj_t* imgbtn, lv_btn_state_t state, lv_opa_t recolor_opa);
 ...
 * to a file)
 */
LV_EXPORT_API void lv_imgbtn_set_src_tiled(lv_obj_t * imgbtn, lv_btn_state_t state, const void * src_left, const void * src_mid,
 ...
 */
LV_EXPORT_API void lv_imgbtn_set_state(lv_obj_t * imgbtn, lv_btn_state_t state);

/**
 * Toggle the state of the image button (ON->OFF, OFF->ON)
 * @param imgbtn pointer to a image button object
 */
LV_EXPORT_API void lv_imgbtn_toggle(lv_obj_t * imgbtn);
 ...
 */
LV_EXPORT_API const void * lv_imgbtn_get_src(lv_obj_t * imgbtn, lv_btn_state_t state);
 ...
 */
LV_EXPORT_API const void * lv_imgbtn_get_src_left(lv_obj_t * imgbtn, lv_btn_state_t state);
 ...
 */
LV_EXPORT_API const void * lv_imgbtn_get_src_middle(lv_obj_t * imgbtn, lv_btn_state_t state);
 ...
 * @return pointer to the left image source (a C array or path to a file)
 */
LV_EXPORT_API const void * lv_imgbtn_get_src_right(lv_obj_t * imgbtn, lv_btn_state_t state);
