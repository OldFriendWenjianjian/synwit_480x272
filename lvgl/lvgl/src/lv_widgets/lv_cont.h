...
enum {
    ...
    LV_LAYOUT_CENTER_ROW, /**< Center objects row*/
    /**
     * COLUMN:
 ...
 */
LV_EXPORT_API lv_obj_t * lv_cont_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_cont_set_layout(lv_obj_t * cont, lv_layout_t layout);
 ...
 */
LV_EXPORT_API void lv_cont_set_fit4(lv_obj_t * cont, lv_fit_t left, lv_fit_t right, lv_fit_t top, lv_fit_t bottom);
 ...
 */
LV_EXPORT_API lv_layout_t lv_cont_get_layout(const lv_obj_t * cont);
 ...
 */
LV_EXPORT_API lv_fit_t lv_cont_get_fit_left(const lv_obj_t * cont);
 ...
 * @return an element of `lv_fit_t`
 */
LV_EXPORT_API lv_fit_t lv_cont_get_fit_right(const lv_obj_t * cont);
 ...
 * @return an element of `lv_fit_t`
 */
LV_EXPORT_API lv_fit_t lv_cont_get_fit_top(const lv_obj_t * cont);
 ...
 * @return an element of `lv_fit_t`
 */
LV_EXPORT_API lv_fit_t lv_cont_get_fit_bottom(const lv_obj_t * cont);
