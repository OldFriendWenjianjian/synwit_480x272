 ...
 */
LV_EXPORT_API lv_obj_t * lv_dropdown_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_text(lv_obj_t * ddlist, const char * txt);

/**
 * Clear any options in a drop down list.  Static or dynamic.
 * @param ddlist pointer to drop down list object
 */
LV_EXPORT_API void lv_dropdown_clear_options(lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_options(lv_obj_t * ddlist, const char * options);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_options_static(lv_obj_t * ddlist, const char * options);
 ...
 */
LV_EXPORT_API void lv_dropdown_add_option(lv_obj_t * ddlist, const char * option, uint32_t pos);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_selected(lv_obj_t * ddlist, uint16_t sel_opt);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_dir(lv_obj_t * ddlist, lv_dropdown_dir_t dir);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_max_height(lv_obj_t * ddlist, lv_coord_t h);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_symbol(lv_obj_t * ddlist, const char * symbol);
 ...
 */
LV_EXPORT_API void lv_dropdown_set_show_selected(lv_obj_t * ddlist, bool show);
 ...
 */
LV_EXPORT_API const char * lv_dropdown_get_text(lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API const char * lv_dropdown_get_options(const lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API uint16_t lv_dropdown_get_selected(const lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API uint16_t lv_dropdown_get_option_cnt(const lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API void lv_dropdown_get_selected_str(const lv_obj_t * ddlist, char * buf, uint32_t buf_size);
 ...
 */
LV_EXPORT_API lv_coord_t lv_dropdown_get_max_height(const lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API const char * lv_dropdown_get_symbol(lv_obj_t * ddlist);
 ...
 * @return the symbol or NULL if not enabled
 */
LV_EXPORT_API lv_dropdown_dir_t lv_dropdown_get_dir(const lv_obj_t * ddlist);
 ...
 * @return true/false
 */
LV_EXPORT_API bool lv_dropdown_get_show_selected(lv_obj_t * ddlist);
 ...
 * @param ddlist pointer to drop down list object
 */
LV_EXPORT_API void lv_dropdown_open(lv_obj_t * ddlist);
 ...
 */
LV_EXPORT_API void lv_dropdown_close(lv_obj_t * ddlist);
