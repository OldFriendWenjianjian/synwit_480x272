...
typedef uint8_t lv_textarea_part_t;
 ...
 */
LV_EXPORT_API lv_obj_t * lv_textarea_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_textarea_add_char(lv_obj_t * ta, uint32_t c);
 ...
 */
LV_EXPORT_API void lv_textarea_add_text(lv_obj_t * ta, const char * txt);

/**
 * Delete a the left character from the current cursor position
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_del_char(lv_obj_t * ta);

/**
 * Delete the right character from the current cursor position
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_del_char_forward(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API void lv_textarea_set_text(lv_obj_t * ta, const char * txt);
 ...
 * @param txt pointer to the text
 */
LV_EXPORT_API void lv_textarea_set_placeholder_text(lv_obj_t * ta, const char * txt);
 ...
 */
LV_EXPORT_API void lv_textarea_set_cursor_pos(lv_obj_t * ta, int32_t pos);
 ...
 */
LV_EXPORT_API void lv_textarea_set_cursor_hidden(lv_obj_t * ta, bool hide);
 ...
 */
LV_EXPORT_API void lv_textarea_set_cursor_click_pos(lv_obj_t * ta, bool en);
 ...
 */
LV_EXPORT_API void lv_textarea_set_pwd_mode(lv_obj_t * ta, bool en);
 ...
 */
LV_EXPORT_API void lv_textarea_set_one_line(lv_obj_t * ta, bool en);
 ...
 */
LV_EXPORT_API void lv_textarea_set_text_align(lv_obj_t * ta, lv_label_align_t align);
 ...
 */
LV_EXPORT_API void lv_textarea_set_accepted_chars(lv_obj_t * ta, const char * list);
 ...
 */
LV_EXPORT_API void lv_textarea_set_max_length(lv_obj_t * ta, uint32_t num);
 ...
 * `static`)
 */
LV_EXPORT_API void lv_textarea_set_insert_replace(lv_obj_t * ta, const char * txt);
 ...
 */
LV_EXPORT_API void lv_textarea_set_text_sel(lv_obj_t * ta, bool en);
 ...
 */
LV_EXPORT_API void lv_textarea_set_pwd_show_time(lv_obj_t * ta, uint16_t time);
 ...
 */
LV_EXPORT_API void lv_textarea_set_cursor_blink_time(lv_obj_t * ta, uint16_t time);
 ...
 */
LV_EXPORT_API const char * lv_textarea_get_text(const lv_obj_t * ta);
 ...
 * @return pointer to the text
 */
LV_EXPORT_API const char * lv_textarea_get_placeholder_text(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API lv_obj_t * lv_textarea_get_label(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API uint32_t lv_textarea_get_cursor_pos(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_get_cursor_hidden(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_get_cursor_click_pos(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_get_pwd_mode(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_get_one_line(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API const char * lv_textarea_get_accepted_chars(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API uint32_t lv_textarea_get_max_length(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_text_is_selected(const lv_obj_t * ta);
 ...
 */
LV_EXPORT_API bool lv_textarea_get_text_sel_en(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API uint16_t lv_textarea_get_pwd_show_time(lv_obj_t * ta);
 ...
 */
LV_EXPORT_API uint16_t lv_textarea_get_cursor_blink_time(lv_obj_t * ta);
 ...
 * @param ta Text area object
 */
LV_EXPORT_API void lv_textarea_clear_selection(lv_obj_t * ta);

/**
 * Move the cursor one character right
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_cursor_right(lv_obj_t * ta);

/**
 * Move the cursor one character left
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_cursor_left(lv_obj_t * ta);

/**
 * Move the cursor one line down
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_cursor_down(lv_obj_t * ta);

/**
 * Move the cursor one line up
 * @param ta pointer to a text area object
 */
LV_EXPORT_API void lv_textarea_cursor_up(lv_obj_t * ta);
