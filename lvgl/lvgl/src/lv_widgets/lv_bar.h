 ...
 */
LV_EXPORT_API lv_obj_t * lv_bar_create(lv_obj_t * par, const lv_obj_t * copy);
 ...
 */
LV_EXPORT_API void lv_bar_set_value(lv_obj_t * bar, int16_t value, lv_anim_enable_t anim);
 ...
 * @param anim LV_ANIM_ON: set the value with an animation; LV_ANIM_OFF: change the value immediately
 */
LV_EXPORT_API void lv_bar_set_start_value(lv_obj_t * bar, int16_t start_value, lv_anim_enable_t anim);
 ...
 */
LV_EXPORT_API void lv_bar_set_range(lv_obj_t * bar, int16_t min, int16_t max);
 ...
 * @param type bar type
 */
LV_EXPORT_API void lv_bar_set_type(lv_obj_t * bar, lv_bar_type_t type);
 ...
 */
LV_EXPORT_API void lv_bar_set_anim_time(lv_obj_t * bar, uint16_t anim_time);
 ...
 */
LV_EXPORT_API int16_t lv_bar_get_value(const lv_obj_t * bar);
 ...
 */
LV_EXPORT_API int16_t lv_bar_get_start_value(const lv_obj_t * bar);
 ...
 */
LV_EXPORT_API int16_t lv_bar_get_min_value(const lv_obj_t * bar);
 ...
 */
LV_EXPORT_API int16_t lv_bar_get_max_value(const lv_obj_t * bar);
 ...
 * @return bar type
 */
LV_EXPORT_API lv_bar_type_t lv_bar_get_type(lv_obj_t * bar);
 ...
 */
LV_EXPORT_API uint16_t lv_bar_get_anim_time(const lv_obj_t * bar);
