 ...
 */
LV_EXPORT_API void _lv_bidi_process(const char * str_in, char * str_out, lv_bidi_dir_t base_dir);
 ...
 */
LV_EXPORT_API lv_bidi_dir_t _lv_bidi_detect_base_dir(const char * txt);
 ...
 */
LV_EXPORT_API uint16_t _lv_bidi_get_logical_pos(const char * str_in, char ** bidi_txt, uint32_t len, lv_bidi_dir_t base_dir,
 ...
 */
LV_EXPORT_API uint16_t _lv_bidi_get_visual_pos(const char * str_in, char ** bidi_txt, uint16_t len, lv_bidi_dir_t base_dir,
 ...
 */
LV_EXPORT_API void _lv_bidi_process_paragraph(const char * str_in, char * str_out, uint32_t len, lv_bidi_dir_t base_dir,
