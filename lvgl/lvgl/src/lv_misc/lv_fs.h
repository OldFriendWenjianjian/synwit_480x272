 ...
 */
LV_EXPORT_API void _lv_fs_init(void);
 ...
 */
LV_EXPORT_API void lv_fs_drv_init(lv_fs_drv_t * drv);
 ...
 */
LV_EXPORT_API void lv_fs_drv_register(lv_fs_drv_t * drv_p);
 ...
 */
LV_EXPORT_API lv_fs_drv_t * lv_fs_get_drv(char letter);
 ...
 */
LV_EXPORT_API bool lv_fs_is_ready(char letter);
 ...
 */
LV_EXPORT_API lv_fs_res_t lv_fs_open(lv_fs_file_t * file_p, const char * path, lv_fs_mode_t mode);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_close(lv_fs_file_t * file_p);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_remove(const char * path);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_read(lv_fs_file_t * file_p, void * buf, uint32_t btr, uint32_t * br);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_write(lv_fs_file_t * file_p, const void * buf, uint32_t btw, uint32_t * bw);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_seek(lv_fs_file_t * file_p, int32_t pos, lv_fs_whence_t whence);
 ...
 */
LV_EXPORT_API lv_fs_res_t lv_fs_tell(lv_fs_file_t * file_p, uint32_t * pos);
 ...
 */
LV_EXPORT_API lv_fs_res_t lv_fs_trunc(lv_fs_file_t * file_p);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_size(lv_fs_file_t * file_p, uint32_t * size);
 ...
 * @return LV_FS_RES_OK or any error from 'fs_res_t'
 */
LV_EXPORT_API lv_fs_res_t lv_fs_rename(const char * oldname, const char * newname);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_dir_open(lv_fs_dir_t * rddir_p, const char * path);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_dir_read(lv_fs_dir_t * rddir_p, char * fn);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_dir_close(lv_fs_dir_t * rddir_p);
 ...
 * @return LV_FS_RES_OK or any error from lv_fs_res_t enum
 */
LV_EXPORT_API lv_fs_res_t lv_fs_free_space(char letter, uint32_t * total_p, uint32_t * free_p);
 ...
 * @return the buffer
 */
LV_EXPORT_API char * lv_fs_get_letters(char * buf);
 ...
 */
LV_EXPORT_API const char * lv_fs_get_ext(const char * fn);
 ...
 */
LV_EXPORT_API char * lv_fs_up(char * path);
 ...
 */
LV_EXPORT_API const char * lv_fs_get_last(const char * path);
