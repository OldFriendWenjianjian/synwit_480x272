 ...
 * line breaks
 */
LV_EXPORT_API void _lv_txt_get_size(lv_point_t * size_res, const char * text, const lv_font_t * font, lv_coord_t letter_space,
 ...
 * they are different)
 */
LV_EXPORT_API uint32_t _lv_txt_get_next_line(const char * txt, const lv_font_t * font, lv_coord_t letter_space, lv_coord_t max_width,
                               lv_txt_flag_t flag);
 ...
 */
LV_EXPORT_API lv_coord_t _lv_txt_get_width(const char * txt, uint32_t length, const lv_font_t * font, lv_coord_t letter_space,
                             lv_txt_flag_t flag);
 ...
 */
LV_EXPORT_API bool _lv_txt_is_cmd(lv_txt_cmd_state_t * state, uint32_t c);
 ...
 */
LV_EXPORT_API void _lv_txt_ins(char * txt_buf, uint32_t pos, const char * ins_txt);
 ...
 */
LV_EXPORT_API void _lv_txt_cut(char * txt, uint32_t pos, uint32_t len);
 ...
 */
LV_EXPORT_API char * _lv_txt_set_text_vfmt(const char * fmt, va_list ap);
