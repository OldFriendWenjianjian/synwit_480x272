 ...
 * GLOBAL PROTOTYPES
 **********************/
LV_EXPORT_API bool lv_debug_check_null(const void * p);

LV_EXPORT_API bool lv_debug_check_mem_integrity(void);

LV_EXPORT_API bool lv_debug_check_str(const void * str);

LV_EXPORT_API void lv_debug_log_error(const char * msg, uint64_t value);
