 ...
 */
LV_EXPORT_API void _lv_task_core_init(void);
 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_TASK_HANDLER uint32_t lv_task_handler(void);
 ...
 */
LV_EXPORT_API lv_task_t * lv_task_create_basic(void);
 ...
 */
LV_EXPORT_API lv_task_t * lv_task_create(lv_task_cb_t task_xcb, uint32_t period, lv_task_prio_t prio, void * user_data);

/**
 * Delete a lv_task
 * @param task pointer to task_cb created by task
 */
LV_EXPORT_API void lv_task_del(lv_task_t * task);
 ...
 */
LV_EXPORT_API void lv_task_set_cb(lv_task_t * task, lv_task_cb_t task_cb);
 ...
 */
LV_EXPORT_API void lv_task_set_prio(lv_task_t * task, lv_task_prio_t prio);
 ...
 */
LV_EXPORT_API void lv_task_set_period(lv_task_t * task, uint32_t period);

/**
 * Make a lv_task ready. It will not wait its period.
 * @param task pointer to a lv_task.
 */
LV_EXPORT_API void lv_task_ready(lv_task_t * task);
 ...
 */
LV_EXPORT_API void lv_task_set_repeat_count(lv_task_t * task, int32_t repeat_count);
 ...
 * @param task pointer to a lv_task.
 */
LV_EXPORT_API void lv_task_reset(lv_task_t * task);

/**
 * Enable or disable the whole lv_task handling
 * @param en: true: lv_task handling is running, false: lv_task handling is suspended
 */
LV_EXPORT_API void lv_task_enable(bool en);

/**
 * Get idle percentage
 * @return the lv_task idle in percentage
 */
LV_EXPORT_API uint8_t lv_task_get_idle(void);
 ...
 */
LV_EXPORT_API lv_task_t * lv_task_get_next(lv_task_t * task);
