 ...
 */
LV_EXPORT_API void _lv_anim_core_init(void);
 ...
 */
LV_EXPORT_API void lv_anim_init(lv_anim_t * a);
 ...
 */
LV_EXPORT_API void lv_anim_start(lv_anim_t * a);
 ...
 */
LV_EXPORT_API bool lv_anim_del(void * var, lv_anim_exec_xcb_t exec_cb);

/**
 * Delete all the animations animation
 */
LV_EXPORT_API void lv_anim_del_all(void);
 ...
 */
LV_EXPORT_API lv_anim_t * lv_anim_get(void * var, lv_anim_exec_xcb_t exec_cb);
 ...
 */
LV_EXPORT_API uint16_t lv_anim_count_running(void);
 ...
 */
LV_EXPORT_API uint32_t lv_anim_speed_to_time(uint32_t speed, lv_anim_value_t start, lv_anim_value_t end);
 ...
 */
LV_EXPORT_API void lv_anim_refr_now(void);
 ...
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_linear(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_ease_in(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_ease_out(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_ease_in_out(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_overshoot(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_bounce(const lv_anim_path_t * path, const lv_anim_t * a);
 ...
 * @return the current value to set
 */
LV_EXPORT_API lv_anim_value_t lv_anim_path_step(const lv_anim_path_t * path, const lv_anim_t * a);
