 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_FAST_MEM int16_t _lv_trigo_sin(int16_t angle);
 ...
 */
LV_EXPORT_API uint32_t _lv_bezier3(uint32_t t, uint32_t u0, uint32_t u1, uint32_t u2, uint32_t u3);
 ...
 */
LV_EXPORT_API uint16_t _lv_atan2(int x, int y);
 ...
 * Else: mask = 0x8000
 */
LV_EXPORT_API LV_ATTRIBUTE_FAST_MEM void _lv_sqrt(uint32_t x, lv_sqrt_res_t * q, uint32_t mask);
 ...
 */
LV_EXPORT_API int64_t _lv_pow(int64_t base, int8_t exp);
 ...
 */
LV_EXPORT_API int32_t _lv_map(int32_t x, int32_t min_in, int32_t max_in, int32_t min, int32_t max);
