 ...
 */
LV_EXPORT_API void lv_theme_set_act(lv_theme_t * th);

/**
 * Get the current system theme.
 * @return pointer to the current system theme. NULL if not set.
 */
LV_EXPORT_API lv_theme_t * lv_theme_get_act(void);
 ...
 */
LV_EXPORT_API void lv_theme_apply(lv_obj_t * obj, lv_theme_style_t name);
 ...
 */
LV_EXPORT_API void lv_theme_copy(lv_theme_t * theme, const lv_theme_t * copy);
 ...
 */
LV_EXPORT_API void lv_theme_set_base(lv_theme_t * new_theme, lv_theme_t * base);
 ...
 */
LV_EXPORT_API void lv_theme_set_apply_cb(lv_theme_t * theme, lv_theme_apply_cb_t apply_cb);

/**
 * Get the small font of the theme
 * @return pointer to the font
 */
LV_EXPORT_API const lv_font_t * lv_theme_get_font_small(void);

/**
 * Get the normal font of the theme
 * @return pointer to the font
 */
LV_EXPORT_API const lv_font_t * lv_theme_get_font_normal(void);

/**
 * Get the subtitle font of the theme
 * @return pointer to the font
 */
LV_EXPORT_API const lv_font_t * lv_theme_get_font_subtitle(void);

/**
 * Get the title font of the theme
 * @return pointer to the font
 */
LV_EXPORT_API const lv_font_t * lv_theme_get_font_title(void);

/**
 * Get the primary color of the theme
 * @return the color
 */
LV_EXPORT_API lv_color_t lv_theme_get_color_primary(void);

/**
 * Get the secondary color of the theme
 * @return the color
 */
LV_EXPORT_API lv_color_t lv_theme_get_color_secondary(void);

/**
 * Get the flags of the theme
 * @return the flags
 */
LV_EXPORT_API uint32_t lv_theme_get_flags(void);
