...
enum {
    ...
    LV_IMG_CF_GRAYSCALE_8BIT,          /**< LV_IMG_CF_USER_ENCODED_0 */
    LV_IMG_CF_SYNWIT_IMGEX,            /**< User holder encoding format. */
 ...
 */
LV_EXPORT_API lv_img_dsc_t * lv_img_buf_alloc(lv_coord_t w, lv_coord_t h, lv_img_cf_t cf);
 ...
 */
LV_EXPORT_API lv_color_t lv_img_buf_get_px_color(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y, lv_color_t color);
 ...
 */
LV_EXPORT_API lv_opa_t lv_img_buf_get_px_alpha(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y);
 ...
 * @param safe true: check out of bounds
 */
LV_EXPORT_API void lv_img_buf_set_px_color(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y, lv_color_t c);
 ...
 * @param safe true: check out of bounds
 */
LV_EXPORT_API void lv_img_buf_set_px_alpha(lv_img_dsc_t * dsc, lv_coord_t x, lv_coord_t y, lv_opa_t opa);
 ...
 */
LV_EXPORT_API void lv_img_buf_set_palette(lv_img_dsc_t * dsc, uint8_t id, lv_color_t c);

/**
 * Free an allocated image buffer
 * @param dsc image buffer to free
 */
LV_EXPORT_API void lv_img_buf_free(lv_img_dsc_t * dsc);
 ...
 */
LV_EXPORT_API uint32_t lv_img_buf_get_img_size(lv_coord_t w, lv_coord_t h, lv_img_cf_t cf);
 ...
 */
LV_EXPORT_API void _lv_img_buf_transform_init(lv_img_transform_dsc_t * dsc);

/**
 * Continue transformation by taking the neighbors into account
 * @param dsc pointer to the transformation descriptor
 */
LV_EXPORT_API bool _lv_img_buf_transform_anti_alias(lv_img_transform_dsc_t * dsc);
 ...
 */
LV_EXPORT_API void _lv_img_buf_get_transformed_area(lv_area_t * res, lv_coord_t w, lv_coord_t h, int16_t angle, uint16_t zoom,
