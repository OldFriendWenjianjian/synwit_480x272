 ...
 */
LV_EXPORT_API lv_img_cache_entry_t * _lv_img_cache_open(const void * src, lv_color_t color);
 ...
 */
LV_EXPORT_API void lv_img_cache_set_size(uint16_t new_slot_num);
 ...
 */
LV_EXPORT_API void lv_img_cache_invalidate_src(const void * src);
