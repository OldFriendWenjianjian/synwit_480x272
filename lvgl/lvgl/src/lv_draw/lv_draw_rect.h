...
LV_EXPORT_API LV_ATTRIBUTE_FAST_MEM void lv_draw_rect_dsc_init(lv_draw_rect_dsc_t * dsc);
 ...
 */
LV_EXPORT_API void lv_draw_rect(const lv_area_t * coords, const lv_area_t * mask, const lv_draw_rect_dsc_t * dsc);
 ...
 */
LV_EXPORT_API void lv_draw_px(const lv_point_t * point, const lv_area_t * clip_area, const lv_style_t * style);
