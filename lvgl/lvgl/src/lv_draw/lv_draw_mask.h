 ...
 */
LV_EXPORT_API int16_t lv_draw_mask_add(void * param, void * custom_id);
 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_FAST_MEM lv_draw_mask_res_t lv_draw_mask_apply(lv_opa_t * mask_buf, lv_coord_t abs_x, lv_coord_t abs_y,
                                                            lv_coord_t len);
 ...
 */
LV_EXPORT_API void * lv_draw_mask_remove_id(int16_t id);
 ...
 * If more masks have `custom_id` ID then the last mask's parameter will be returned
 */
LV_EXPORT_API void * lv_draw_mask_remove_custom(void * custom_id);
 ...
 */
LV_EXPORT_API LV_ATTRIBUTE_FAST_MEM uint8_t lv_draw_mask_get_cnt(void);
 ...
 */
LV_EXPORT_API void lv_draw_mask_line_points_init(lv_draw_mask_line_param_t * param, lv_coord_t p1x, lv_coord_t p1y, lv_coord_t p2x,
 ...
 * With `LV_DRAW_MASK_LINE_SIDE_TOP/BOTTOM` and vertical line all pixels are kept
 */
LV_EXPORT_API void lv_draw_mask_line_angle_init(lv_draw_mask_line_param_t * param, lv_coord_t p1x, lv_coord_t py, int16_t angle,
 ...
 */
LV_EXPORT_API void lv_draw_mask_angle_init(lv_draw_mask_angle_param_t * param, lv_coord_t vertex_x, lv_coord_t vertex_y,
 ...
 */
LV_EXPORT_API void lv_draw_mask_radius_init(lv_draw_mask_radius_param_t * param, const lv_area_t * rect, lv_coord_t radius, bool inv);
 ...
 */
LV_EXPORT_API void lv_draw_mask_fade_init(lv_draw_mask_fade_param_t * param, const lv_area_t * coords, lv_opa_t opa_top,
                            lv_coord_t y_top,
 ...
 */
LV_EXPORT_API void lv_draw_mask_map_init(lv_draw_mask_map_param_t * param, const lv_area_t * coords, const lv_opa_t * map);
