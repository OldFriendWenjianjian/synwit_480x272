 ...
 */
LV_EXPORT_API void lv_draw_triangle(const lv_point_t points[], const lv_area_t * clip, const lv_draw_rect_dsc_t * draw_dsc);
 ...
 * @param draw_dsc pointer to an initialized `lv_draw_rect_dsc_t` variable
 */
LV_EXPORT_API void lv_draw_polygon(const lv_point_t points[], uint16_t point_cnt, const lv_area_t * mask,
