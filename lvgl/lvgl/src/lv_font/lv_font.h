 ...
 */
LV_EXPORT_API const uint8_t * lv_font_get_glyph_bitmap(const lv_font_t * font_p, uint32_t letter);
 ...
 */
LV_EXPORT_API bool lv_font_get_glyph_dsc(const lv_font_t * font_p, lv_font_glyph_dsc_t * dsc_out, uint32_t letter,
 ...
 */
LV_EXPORT_API uint16_t lv_font_get_glyph_width(const lv_font_t * font, uint32_t letter, uint32_t letter_next);
...
#define LV_FONT_DECLARE(font_name) extern LV_EXPORT_API lv_font_t font_name;
