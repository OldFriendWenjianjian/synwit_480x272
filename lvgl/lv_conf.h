...
#  define LV_MEM_ATTR
#else
    #if !defined(MEM_SIZE_MB)
        #define MEM_SIZE_MB     8
    #endif

    #define LV_MEM_SIZE    (MEM_SIZE_MB * 1024U * 1024U)

#ifdef SWM330_APP
    #define LV_FASTMEM_SIZE (52 * 1024)          /**< [bytes] */

    #define LV_MEM_ATTR       __attribute__((section(".bss.PSRAM")))
    #define LV_FASTMEM_ATTR   //__attribute__((section(".SRAM")))
#else
    /* Compiler prefix for a big array declaration */
    #define LV_MEM_ATTR       __attribute__((section(".bss.NoInit")))
#endif
#endif
...
#define LV_INDEV_DEF_GESTURE_LIMIT        3
...
/*If enabling LV_USE_GPU_SWM341_DMA2D, LV_GPU_SWM341_DMA2D_INCLUDE must be defined to include path of CMSIS header of target processor */
#define LV_GPU_SWM341_DMA2D_INCLUDE "SWM341.h"

#ifdef SWM330_APP
#define LV_USE_GPU_SWM330_DMA2D  1
/*If enabling LV_USE_GPU_SWM330_DMA2D, LV_GPU_SWM330_DMA2D_INCLUDE must be defined to include path of CMSIS header of target processor */
#define LV_GPU_SWM330_DMA2D_INCLUDE "SWM330.h"
#endif
 ...
 * Uses 15-20 kB extra memory */
    ...
    #define LV_ATTRIBUTE_FAST_MEM
        ...
        #define LV_ATTRIBUTE_FAST_MEM   __attribute__((section(".FRAMEWORK_FAST_MEM")))
    #else
        #define LV_ATTRIBUTE_FAST_MEM
    #endif
...
#define LV_THEME_DEFAULT_DEINIT             lv_theme_empty_deinit
...
#if LV_USE_FS_IF
#if defined(WIN32) || defined(_WINDOWS)
#  define LV_FS_IF_PC       'P' /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
#if LV_FS_IF_PC != '\0'
#  define LV_FS_PC_PATH ""   /*Set the working directory. File/directory paths will be appended to it.*/
#endif
#else
